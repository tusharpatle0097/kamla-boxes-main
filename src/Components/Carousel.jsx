          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10">
              <h1
                ...
                className="lg:text-4xl text-xl font-extrabold px-8 py-6 rounded-lg text-center shadow-lg tracking-wide transform transition-transform duration-300 hover:scale-105"
              >
                " KAMLA CORRUGATED BOX MANUFACTURING PVT LTD." <br />
                <span className="lg:text-[1.2rem] text-red-400">
                  Since 1979
                </span>
              </h1>
            </div>
