  ...
  const teamMembers = [
    {
      ...
      description: `We are one of the leading manufacturers of corrugated boxes and duplex cartons in the country. Established in the year 1979, we have over three decades of experience in this field. Our founder Mr. Arun Bhandari is one of the distinguished creed of the first-generation entrepreneurs, who has, through vision and dedication, carved a niche for himself in the field of corrugated boxes and duplex cartons manufacturing. His farsightedness has placed “ARIHANT” group as a key player in the packaging league.`,
    },
    {
      role: "Group CEO & CFO",
