...
const Navbar = () => {
  ...
  return (
    <nav
      className="from-blue-500 to-purple-600 p-5 shadow-md fixed top-0 w-full z-50"
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="text-black font-bold text-xl">
          <div className="flex gap-4 center justify-center items-center">
            ...
            >
              {" "}
              Kamla Corrugated Box Manufacturing Pvt Ltd.
            </span>
          </div>
        </div>

        {/* Hamburger Icon for Mobile Menu */}
        <button className="text-black lg:hidden block" onClick={toggleMenu}>
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
